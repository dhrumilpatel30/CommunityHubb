<%@ Page Title="Communities" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="CommunityHubb.ManageCommunity.Index" %>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <div class="d-flex justify-content-md-start">
                                                    <div class="text-start" style='font-weight: 600'>Description:<span class="fw-bold d-block"> <%# Eval("Description") %></span></div>
                                                </div>
                                            </div>
                                            <div class="col-6 text-end fs-5 fw-bold">
                                                <div><%#Eval("CommunityUsers.Count") %> Follower(s)</div>
                                                <div><%#Eval("Posts.Count") %> Post(s)</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
