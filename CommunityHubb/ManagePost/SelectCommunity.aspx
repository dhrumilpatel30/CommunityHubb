    ...
    <main>
        <div class="container p-3">
            ...
            <table class="table-borderless w-100">
                <asp:Repeater runat="server" ID="userCommunities">
                    <ItemTemplate>
                        <tr>
                            <div class="col-12 m-2">
                                <div onclick='window.location=`<%#Request.Url.Scheme + "://" + Request.Url.Authority + Request.ApplicationPath.TrimEnd('/') + "/" %>ManagePost/Create.aspx?id=<%#Eval("Id") %>`'
