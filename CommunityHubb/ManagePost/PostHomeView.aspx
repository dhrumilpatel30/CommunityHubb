...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <main>
        ...
        <div class="col-lg-3 col-md-5 col-sm-12 border border-2 rounded-2 p-4 h-100" style="height: fit-content;top: 75px; position:sticky;">
            <h2 class="fw-bold fs-4 pb-2">Filter Posts</h2>
           
            <div class="form-group">
                <label class="fs-5 fw-bold">Post Type:</label>
                <div class="form-check ps-2 p-1 fw-bold">
                    <asp:RadioButton ID="publicRadio" runat="server" Text="Public" GroupName="postType" Checked="True" />
                </div>
                <div class="form-check ps-2 p-1 fw-bold">
                    <asp:RadioButton ID="privateRadio" runat="server" Text="Private" GroupName="postType" />
                </div> 
                <div class="form-check ps-2 p-1 fw-bold">
                    <asp:RadioButton ID="bothRadio" runat="server" Text="Both" GroupName="postType"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-check ps-2 p-1 fw-bold">
                    <asp:RadioButton ID="followedRadio" runat="server" Text="Followed Posts" GroupName="viewPosts" Checked="True" />
                </div>
                <div class="form-check ps-2 p-1 fw-bold">
                    <asp:RadioButton ID="unfollowedRadio" runat="server" Text="Unfollowed Posts" GroupName="viewPosts" />
                </div>
                <div class="form-check ps-2 p-1 fw-bold">
                    <asp:RadioButton ID="bothViewRadio" runat="server" Text="Both" GroupName="viewPosts" />
                </div>
            </div>
